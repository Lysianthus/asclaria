...
function sAsclaria() {
	...
	var s_description = "Asclaria is my umbrella network. All of my personal websites, cliques, fanlistings, fansites, shrines, tributes, and miscellaneous projects are under this umbrella.";
	var s_url = 'https://asclaria.org';
	var s_image = '/assets/images/asclaria.png?v=5';
...
function sLysianthus() {
	...
	var s_description = "Lysianthus is my personal homepage. This is my “home base”. My accounts to other websites as well as my contact information can be found here.";
...
function sVVVVVV() {
	var s_title = "VVVVVV";
	var s_description = "VVVVVV is a place of nonsense. Sometimes, I put temporary projects here. Most often, this is where I just mess around.";
...
function sTHHQ() {
	...
	var s_description = "Throwaway Headquarters is the headquarters for all of my throwaway websites.";

<?php
	$title = "Fandom-Related Projects | ";
	include 'includes/header.php';
?>

	<main id="content">
		<h1 class="heading">Fandom-Related Projects</h1>
		...
		<div class="projects">
			...
			<div class="project">
				...
				<p>LA NIghtingale is a tribute by Lysianthus to her favorite singer of all time, <i>Asia’s Nightingale</i> and Last Vegas’ <i>Siren of the Strip</i>, Lani Misalucha.</p>
			...
			<div class="project">
				...
				<p><a class="go" target="_blank" href="http://vernaflamingo.isamotherfucking.ninja"><img alt="" src="/assets/images/butt_cat.png" /></a></p>
			</div> <!-- .project -->
			<!-- 
			<div class="project">
			...
			<div class="project">
				...
				<p><a class="go" target="_blank" href="http://canonize.asclaria.org"><img alt="" src="/assets/images/butt_cat.png" /></a></p>
			</div> <!-- .project -->
		</div> <!-- .projects -->
	</main> <!-- #content -->

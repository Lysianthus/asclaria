...
<?php include 'includes/page__menu.php'; ?>
		...
		<article class="article">
			...
			<p style="display: flex; justify-content: center; align-items: flex-start; flex-wrap: wrap;">
				...
				<a target="_blank" href="http://midnight-cloud.net" style="margin: 5px;"><img alt="" src="/assets/images/midnight-cloud.jpg" /></a>
				...
				<a target="_blank" href="http://quicksilver.nu" style="margin: 5px;"><img alt="" src="/assets/images/quicksilver.png" /></a>
				...
				<a target="_blank" href="http://www.sun-cryst.org" style="margin: 5px;"><img alt="" src="/assets/images/sun-cryst.gif" /></a>
